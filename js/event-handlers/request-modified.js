(function() {
	...
	*/
	function RequestChangedHandler(ctx) {
		...
		*/
		this.handleRequestModified=function(event, collection){
	...
	*/
	...
	RequestChangedHandler.prototype.getType=function(){
		return ["event-general-request-created","event-registration-request-created","event-data-request-created",
				"event-general-request-updated","event-registration-request-updated","event-data-request-updated"];
	};
